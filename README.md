...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/myhdl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11585&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/myhdl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `myhdl` can be installed with:

```
conda install myhdl
```

It is possible to list all of the versions of `myhdl` available on your platform with:
